...
<Tabs>
    <TabItem value="cli" label="CLI" default>
        ```bash
        ignix add component @ignix-ui/list-view-page
        ```
    </TabItem>
...
| `onThemeChange` | `(theme: Theme) => void` | `-` | Notified when the in-page theme switch is toggled. |
| `mode` | `"pagination" \| "infinite-scroll"` | `"pagination"` | Switches between paginated footer and infinite-scroll sentinel. |
| `onModeChange` | `(mode: PaginationMode) => void` | `-` | Notified when the in-page mode switch is toggled. |
...
| `author` | `ListItemAuthor` | `{ name, initials, avatarUrl? }`. |
